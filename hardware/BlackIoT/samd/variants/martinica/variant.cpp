...
/*
 ...
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 | 00         | D0               |  PB16  |                 |  *00   |     |     | X04 |     |   5/00  |         |* TC6/0 | TCC0/4 | I2S/SD1  | GCLK_IO2 | // Martinica
 | 01         | D1               |  PB17  |                 |  *01   |     |     | X05 |     |   5/01  |         |* TC6/1 | TCC0/5 | I2S/MCK0 | GCLK_IO3 | // Martinica
 ...
 | 06         | D6               |  PA20  |                 |  *04   |     |     | X08 |     |   5/02  |   3/02  |  TC7/0 |*TCC0/6 | I2S/SCK0 | GCLK_IO4 |
 | 07         | D7               |  PA21  |                 |  *05   |     |     | X09 |     |   5/03  |   3/03  |  TC7/1 |*TCC0/7 | I2S/FS0  | GCLK_IO5 |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 */
  { PORTB, 16, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER    ), No_ADC_Channel, PWM6_CH0,   TC6_CH0,      EXTERNAL_INT_0    },
...
/*
 ...
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 |            |      Serial1     |        |                 |        |     |     |     |     |         |         |        |        |          |          |
 | 13         | RX               |  PB23  |                 |   07   |     |     |     |     |         |  *5/03  |  TC7/1 | TCC3/1 |          | GCLK_IO1 |
 | 14         | TX               |  PB22  |                 |   06   |     |     |     |     |         |  *5/02  |  TC7/0 | TCC3/0 |          | GCLK_IO0 |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 */
                                                                                                                                               // DIPO=3 DOPO=0
...
/*
 ...
 |            |                  |        |                 |(EXTINT)|(AIN)|(AIN)|     |     | (x/PAD) | (x/PAD) | (x/WO) | (x/WO) |          |          |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 | 15         | A0 / DAC0        |  PA02  |                 |   02   | *00 |     | Y00 | OUT |         |         |        | TCC3/0 |          |          |
 | 16         | A1               |  PB02  |                 |  *02   | *10 |     | Y08 |     |         |   5/00  |  TC6/0 | TCC3/2 |          |          |
 | 17         | A2               |  PB03  |                 |  *03   | *11 |     | Y09 |     |         |   5/01  |  TC6/1 | TCC3/3 |          |          |
 | 18         | A3               |  PA04  |                 |   04   | *04 |  00 | Y02 |     |         |   0/00  |*TCC0/0 | TCC3/2 |          |          |
 | 19         | A4               |  PA05  |                 |   05   | *05 |  01 | Y03 |     |         |   0/01  |*TCC0/1 | TCC3/3 |          |          |
 | 20         | A5               |  PA06  |                 |   06   | *06 |  02 | Y04 |     |         |   0/02  | TCC1/0 | TCC3/4 |          |          |
 | 21         | A6               |  PA07  |                 |   07   | *07 |  03 | Y05 |     |         |   0/03  | TCC1/1 | TCC3/5 | I2S/SD0  |          |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 */
...
/*
 ...
 | 24         |                  |  PA18  | LED_B           |   02   |     |     | X06 |     |   1/02  |   3/02  |  TC3/0 | TCC0/2 |          | AC/CMP0  | // Martinica
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 | 25         | AREF             |  PA03  |                 |   03   |  01 |     | Y01 |     |         |         |        | TCC3/1 |          |          |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 */
...
/*
 ...
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 |            | WiFi SPI         |        |                 |        |     |     |     |     |         |         |        |        |          |          |
 | 26         |                  |  PA12  | WiFi MOSI       |   12   |     |     |     |     |  *2/00  |   4/00  | TCC2/0 | TCC0/6 |          | AC/CMP0  | // Martinica
 | 27         |                  |  PA13  | WiFi SCK        |   13   |     |     |     |     |  *2/01  |   4/01  | TCC2/1 | TCC0/7 |          | AC/CMP1  | // Martinica
 | 28         |                  |  PA14  | WiFi MISO       |   14   |     |     |     |     |  *2/02  |   4/02  |  TC3/0 | TCC0/4 |          | GCLK_IO0 | // Martinica
 | 29         |                  |  PA15  | WiFi IRQn       |   15   |     |     |     |     |  *2/03  |   4/03  |  TC3/1 | TCC0/5 |          | GCLK_IO1 | // Martinica
 | 30         |                  |  PB04  | WiFi CS         |   04   | 12  |  Y0 |     |     |         |         |        |        |          |          | // Martinica
 | 31         |                  |  PB06  | WiFi EN         |   06   | 14  |     |  12 |     |         |         |        |        |          |          | // Martinica 
 | 32         |                  |  PA28  | WiFi RSTn       |   08   |     |     |     |     |         |         |        | TCC3/7 |          | GCLK_IO0 | // Martinica
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
*/
  ...
  { PORTA, 14, PIO_SERCOM,     (PIN_ATTR_NONE                                ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // MISO: SERCOM2/PAD[2] 
  { PORTA, 15, PIO_DIGITAL,    (PIN_ATTR_DIGITAL                             ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15   }, 
  { PORTB,  4, PIO_DIGITAL,    (PIN_ATTR_DIGITAL                             ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SS:   as GPIO
...
/* 
 ...
 |            |                  |        |                 |(EXTINT)|(AIN)|(AIN)|     |     | (x/PAD) | (x/PAD) | (x/WO) | (x/WO) |          |          |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 | 33         |                  |  PA27  | LED_BUILTIN     |   15   |     |     |     |     |         |         |        | TCC3/6 |          | GCLK_IO0 | // Martinica
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 |            | FLASH SPI        |        |                 |        |     |     |     |     |         |         |        |        |          |          |
 | 34         |                  |  PB12  | FLASH MOSI      |   12   |     |     | X12 |     |  *4/00  |         |  TC4/0 | TCC0/6 |          | GCLK_IO6 | // Martinica
 | 35         |                  |  PB13  | FLASH SCK       |   13   |     |     | X13 |     |  *4/01  |         |  TC4/1 | TCC0/7 |          | GCLK_IO7 | // Martinica
 | 36         |                  |  PB14  | FLASH MISO      |   14   |     |     | X14 |     |  *4/02  |         |  TC5/0 |        |          | GCLK_IO0 | // Martinica
 | 37         |                  |  PB15  | FLASH CS        |   15   |     |     | X15 |     |  *4/03  |         |  TC5/1 |        |          | GCLK_IO1 | // Martinica
 +------------+------------------+--------+-----------------+--------------------+-----+-----+---------+---------+--------+--------+----------+----------+
 | 38         |                  |  PB30  | LED_R           |   14   |     |     |     |     |         |   5/00  | TCC0/0 | TCC1/2 |          |          | // Martinica
 | 39         |                  |  PB31  | LED_G           |   15   |     |     |     |     |         |   5/01  | TCC0/1 | TCC1/3 |          |          | // Martinica
 | 40         |                  |  PB00  | ADC_BATTERY     |  *00   |  08 |     | Y06 |     |         |   5/02  |  TC7/0 |        |          |          | // Martinica
 +------------+------------------+--------+-----------------+--------------------+-----+-----+---------+---------+--------+--------+----------+----------+
 |            |       Wire       |        |                 |        |     |     |     |     |         |         |        |        |          |          |
 | 41         | SDA              |  PA22  | SNS_SDA         |   06   |     |     | X10 |     |  *3/00  |   5/00  |  TC4/0 | TCC0/4 |          | GCLK_IO6 | // Martinica
 | 42         | SCL              |  PA23  | SNS_SCL         |   07   |     |     | X11 |     |  *3/01  |   5/01  |  TC4/1 | TCC0/5 |          | GCLK_IO7 | // Martinica
 | 43         |                  |  PB01  | NFC_INT         |   01   |  09 |     | Y07 |     |         |   5/03  |  TC7/1 |        |          |          | // Martinica
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 | 44         |                  |  PB09  | USER_BUTTON     |   09   |  03 |     |     |     |         |   4/01  |  TC4/1 | TCC3/7 |          |          | // Martinica
 | 45         |                  |  PB05  | BME_OFF         |   05   |  13 |     | X11 |     |         |         |        |        |          |          | // Martinica 
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 |            | 32768Hz Crystal  |        |                 |        |     |     |     |     |         |         |        |        |          |          |
 | 46         |                  |  PA00  | XIN32           |   00   |     |     |     |     |         |   1/00  | TCC2/0 |        |          |          |
 | 47         |                  |  PA01  | XOUT32          |   01   |     |     |     |     |         |   1/01  | TCC2/1 |        |          |          |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 */
                                                                                                                                             
//  { PORTA, 27, PIO_DIGITAL,    (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT ), No_ADC_Channel, PWM3_CH6,   TCC3_CH6,     EXTERNAL_INT_NONE },
  ...
  { PORTB, 13, PIO_SERCOM,     (PIN_ATTR_NONE                                ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SCK:  SERCOM4/PAD[1]
  { PORTB, 14, PIO_SERCOM,     (PIN_ATTR_NONE                                ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // MISO: SERCOM4/PAD[2] 
  { PORTB, 15, PIO_DIGITAL,    (PIN_ATTR_DIGITAL                             ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SS:   as GPIO
  
  { PORTB, 30, PIO_DIGITAL,    (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM1_CH2, TCC1_CH2, EXTERNAL_INT_NONE },
  { PORTB, 31, PIO_DIGITAL,    (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM1_CH3, TCC1_CH3, EXTERNAL_INT_NONE },
  { PORTB, 00, PIO_ANALOG,     (PIN_ATTR_NONE                                ), ADC_Channel8,   NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, 
                                                                                                                                               // PINOUT=0
  ...
  { PORTB,  5, PIO_ANALOG,     (PIN_ATTR_PWM|PIN_ATTR_TIMER                  ), ADC_Channel3,   PWM4_CH1,   TC4_CH1,      EXTERNAL_INT_9    },
